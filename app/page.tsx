      ...
      <SectionReveal>
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#1A1A1A]">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#F3F4F6] text-center mb-12">
              Our Impact
            </h2>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-[#9CA3AF] text-center mb-12 max-w-2xl mx-auto leading-relaxed">
              We combine creativity, authenticity, and collaboration to deliver
              exceptional results
            </p>
              ...
              {[
                {
                  ...
                  title: "Creativity",
                  description:
                    "Innovative approaches to storytelling and sound design that captivate audiences",
                },
                {
                  icon: Award,
                  title: "Authenticity",
                  description:
                    "Genuine narratives that resonate with your audience and reflect your brand",
                },
                {
                  icon: Users,
                  title: "Collaboration",
                  description:
                    "Working closely with you to bring your creative vision to life",
                },
              ].map((value, index) => (
                <Card
                  key={index}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <Card
                  key={index}
                  className="bg-[#0E0E0E] border-[#27272A] hover:border-[#C5A36C] transition-colors"
                >
                  <CardContent className="p-6">
