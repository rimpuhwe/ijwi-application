 ...
 */
export default function IntroSection({ duration = 2.5 }: { duration?: number }) {
      ...
      {visible && (
        ...
        >
          ...
          <motion.div
            ...
            style={{ background: `linear-gradient(135deg, ${BRAND.orange} 0%, ${BRAND.gray} 100%)` }}
          ...
          <motion.div
            ...
            style={{ background: `linear-gradient(45deg, ${BRAND.gray} 0%, ${BRAND.orange} 100%)` }}
